    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', borderBottom: '2px solid var(--accent-yellow)', paddingBottom: '2px' }}>
          ...
          <input 
            ...
            style={{ background: 'transparent', border: 'none', color: 'white', outline: 'none', fontFamily: 'var(--font-sans)', fontSize: '1rem', width: '100%' }}
          />
        </div>
        ...
        <div
          ...
          style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', fontFamily: 'var(--font-sans)', fontSize: '0.9rem' }}
        ...
        <div
          ...
          data-tooltip-pos="bottom"
        >
          {toggleDark ? <Moon size={16} /> : <Sun size={16} />}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', background: 'white', color: 'var(--text-dark)', padding: '6px 12px 10px', borderRadius: '4px', transform: 'rotate(-1.5deg)', boxShadow: '2px 2px 0px rgba(0,0,0,0.8)' }}>
          <div style={{ width: '22px', height: '22px', borderRadius: '50%', background: 'white', border: '1.5px solid var(--text-dark)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '0.62rem' }}>D</div>
          <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1 }}>
            <span style={{ fontSize: '0.75rem', fontWeight: 900, fontFamily: 'var(--font-sans)' }}>Det. Alex</span>
      ...
      >
        <div className="metric-sticky-card note-yellow" style={{ transform: 'rotate(-2deg)' }}>
          ...
          <span style={{ fontSize: '0.62rem', fontWeight: 900, textTransform: 'uppercase', color: 'rgba(0,0,0,0.45)', fontFamily: 'var(--font-sans)' }}>open glitches</span>
          <span style={{ fontFamily: 'var(--font-marker)', fontSize: '3.5rem', color: 'var(--text-dark)', margin: '4px 0', textAlign: 'center' }}>{metrics.openBugs}</span>
          <span style={{ fontFamily: 'var(--font-hand)', fontSize: '1rem', color: 'rgba(0,0,0,0.6)', textAlign: 'center' }}>.. crawling trails ..</span>
        </div>

        <div className="metric-sticky-card note-orange" style={{ transform: 'rotate(1.5deg)' }}>
          <div className="tape-strip" style={{ width: '60px', top: '-10px' }}></div>
          <span style={{ fontSize: '0.62rem', fontWeight: 900, textTransform: 'uppercase', color: 'rgba(0,0,0,0.45)', fontFamily: 'var(--font-sans)' }}>resolved cases</span>
          <span style={{ fontFamily: 'var(--font-marker)', fontSize: '3.5rem', color: 'var(--text-dark)', margin: '4px 0', textAlign: 'center' }}>{metrics.resolvedBugs}</span>
          <span style={{ fontFamily: 'var(--font-hand)', fontSize: '1rem', color: 'rgba(0,0,0,0.6)', textAlign: 'center' }}>.. stamps issued today ..</span>
        </div>

        <div className="metric-sticky-card note-purple" style={{ transform: 'rotate(-1deg)' }}>
          <div className="tape-strip" style={{ width: '60px', top: '-10px' }}></div>
          <span style={{ fontSize: '0.62rem', fontWeight: 900, textTransform: 'uppercase', color: 'rgba(0,0,0,0.45)', fontFamily: 'var(--font-sans)' }}>AI suggestions</span>
          <span style={{ fontFamily: 'var(--font-marker)', fontSize: '3.5rem', color: 'var(--text-dark)', margin: '4px 0', textAlign: 'center' }}>{metrics.criticalBlockers}</span>
          <span style={{ fontFamily: 'var(--font-hand)', fontSize: '1rem', color: 'rgba(0,0,0,0.6)', textAlign: 'center' }}>.. robots clue sifting ..</span>
        </div>

        <div className="metric-sticky-card note-blue" style={{ transform: 'rotate(2.5deg)' }}>
          <div className="tape-strip" style={{ width: '60px', top: '-10px' }}></div>
          <span style={{ fontSize: '0.62rem', fontWeight: 900, textTransform: 'uppercase', color: 'rgba(0,0,0,0.45)', fontFamily: 'var(--font-sans)' }}>Sprint velocity</span>
          <span style={{ fontFamily: 'var(--font-marker)', fontSize: '3.5rem', color: 'var(--text-dark)', margin: '4px 0', textAlign: 'center' }}>{metrics.securityEmbargoes}%</span>
          <span style={{ fontFamily: 'var(--font-hand)', fontSize: '1rem', color: 'rgba(0,0,0,0.6)', textAlign: 'center' }}>.. target goals speed ..</span>
        </div>
      </div>
      ...
      >
        ...
        <div>
          <div style={{ fontFamily: 'var(--font-hand)', fontSize: '1.2rem', fontWeight: 'bold', textTransform: 'uppercase', color: 'var(--accent-yellow)', marginBottom: '16px' }}>Burn down chart</div>
        ...
        <div style={{ transform: 'rotate(-2.5deg)', position: 'relative', marginTop: '30px' }}>
          <span style={{ fontSize: '0.65rem', fontWeight: 900, textTransform: 'uppercase', color: 'rgba(255,255,255,0.3)', fontFamily: 'var(--font-sans)' }}>AI clue insight</span>
          <div className="tape-strip" style={{ width: '40px', top: '-15px' }}></div>
          <p style={{ fontFamily: 'var(--font-hand)', fontSize: '1.4rem', color: 'rgba(255,255,255,0.8)', margin: '10px 0 0 0', lineHeight: 1.3 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div style={{ fontFamily: 'var(--font-sans)', fontSize: '1rem', fontWeight: 'bold' }}>Sprint: 80% complete</div>
          </div>

          <div style={{ borderTop: '1px dashed rgba(255,255,255,0.2)', paddingTop: '16px' }}>
            <div style={{ fontSize: '0.7rem', fontWeight: 900, textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)', marginBottom: '10px', fontFamily: 'var(--font-sans)' }}>recent activity timeline</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', fontFamily: 'var(--font-sans)', fontSize: '0.75rem', opacity: 0.8 }}>
      ...
      >
        ...
        <div style={{ background: '#C79A63', padding: '16px', borderRadius: '4px', border: '2px solid var(--text-dark)', boxShadow: '4px 4px 0px rgba(0,0,0,0.8)' }}>
          <div style={{ fontSize: '0.9rem', fontWeight: 900, textTransform: 'uppercase', color: 'white', marginBottom: '16px', fontFamily: 'var(--font-sans)' }}>Kanban columns</div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
            <div style={{ background: 'rgba(0,0,0,0.15)', padding: '12px', borderRadius: '4px' }}>
              <div style={{ fontSize: '0.7rem', fontWeight: 900, color: 'var(--accent-yellow)', marginBottom: '10px' }}>DOING (2)</div>
              <div style={{ background: 'white', color: 'var(--text-dark)', padding: '10px', fontSize: '0.8rem', borderRadius: '2px', fontWeight: 'bold', transform: 'rotate(-2deg)' }}>BS-114 connection</div>
            </div>
            <div style={{ background: 'rgba(0,0,0,0.15)', padding: '12px', borderRadius: '4px' }}>
              <div style={{ fontSize: '0.7rem', fontWeight: 900, color: 'var(--accent-mint)', marginBottom: '10px' }}>DONE (14)</div>
              <div style={{ background: '#60A5FA', color: 'var(--text-dark)', padding: '10px', fontSize: '0.8rem', borderRadius: '2px', fontWeight: 'bold', transform: 'rotate(1.5deg)' }}>BS-108 scroll solved</div>
            </div>
          </div>
        </div>
        ...
        <div>
          <div style={{ fontSize: '0.9rem', fontWeight: 900, textTransform: 'uppercase', color: 'var(--accent-purple)', marginBottom: '16px', fontFamily: 'var(--font-sans)' }}>glitch heatmap</div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '6px' }}>
            {Array.from({ length: 15 }).map((_, i) => (
              <div key={i} style={{ width: '100%', height: '18px', background: i % 3 === 0 ? 'var(--accent-yellow)' : i % 5 === 0 ? 'var(--accent-coral)' : 'var(--accent-mint)', borderRadius: '2px' }} />
            ))}
          </div>
        </div>
        ...
        <div>
          <div style={{ fontSize: '0.9rem', fontWeight: 900, textTransform: 'uppercase', color: 'var(--accent-coral)', marginBottom: '16px', fontFamily: 'var(--font-sans)' }}>mood stamp</div>
        ...
        <div>
          <div style={{ fontSize: '0.9rem', fontWeight: 900, textTransform: 'uppercase', color: 'var(--accent-yellow)', marginBottom: '16px', fontFamily: 'var(--font-sans)' }}>today priorities</div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {priorities.map(p => (
              ...
              >
                <span style={{ color: 'var(--accent-yellow)', display: 'flex', alignItems: 'center' }}>{p.done ? <CheckSquare size={16} /> : <Square size={16} />}</span>
      ...
      >
        {/* GitHub Activity */}
        <div>
          <div style={{ fontSize: '0.85rem', fontWeight: 900, textTransform: 'uppercase', color: 'var(--accent-mint)', marginBottom: '12px', fontFamily: 'var(--font-sans)' }}>git activity stamps</div>
        ...
        >
          <div className="tape-strip" style={{ width: '50px', top: '-8px', left: '50%', transform: 'translateX(-50%) rotate(-2deg)' }}></div>
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.6rem', fontWeight: 900, color: 'rgba(0,0,0,0.4)', textTransform: 'uppercase', fontFamily: 'var(--font-sans)' }}>
            <span>museum slider</span>
            <span>{MUSEUM_BUGS[museumIndex].stamp}</span>
          </div>
          <h4 style={{ fontFamily: 'var(--font-marker)', fontSize: '1.1rem', margin: '8px 0 4px 0' }}>
            {MUSEUM_BUGS[museumIndex].name}
          </h4>
          <p style={{ fontFamily: 'var(--font-hand)', fontSize: '1rem', margin: 0, lineHeight: 1.2 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div onClick={handleCoffeeClick} style={{ display: 'flex', flexDirection: 'column', cursor: 'pointer' }} data-tooltip="Log a cup of coffee (resets after 5)">
              <span style={{ fontSize: '0.85rem', fontWeight: 900, textTransform: 'uppercase', color: 'var(--accent-yellow)', fontFamily: 'var(--font-sans)' }}>caffeine monitor</span>
              <span style={{ fontFamily: 'var(--font-hand)', fontSize: '1rem', opacity: 0.7 }}>{coffeeCups}/5 cups (click to fill)</span>
            </div>
            <Coffee onClick={handleCoffeeClick} size={22} style={{ color: coffeeCups > 0 ? 'var(--accent-yellow)' : 'white', cursor: 'pointer' }} />
          </div>
        ...
        {/* Team Collaboration */}
        <div>
          <div style={{ fontSize: '0.85rem', fontWeight: 900, textTransform: 'uppercase', color: 'white', marginBottom: '12px', fontFamily: 'var(--font-sans)' }}>desk sync</div>
          <div style={{ display: 'flex', gap: '8px' }}>
            {['A', 'C', 'M', 'E'].map(initial => (
              <div 
                key={initial}
