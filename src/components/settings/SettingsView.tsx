...
import { Bell, Moon, Sun, BookOpen, Github, Slack, Code, Database } from 'lucide-react';

const INTEGRATIONS = [
  { id: 'github', label: 'GitHub', icon: <Github size={18} />, color: '#FFFFFF', desc: 'Sync commits & PRs', connected: true },
  { id: 'slack',  label: 'Slack',  icon: <Slack size={18} />, color: '#4A154B', desc: 'Bug alert notifications', connected: false },
