...
export const PRODUCTS: Product[] = [
    ...
    components: [
      {
        ...
        defaultAssignee: 'alice@devtrace.io',
        defaultQaContact: 'david@devtrace.io',
      ...
      },
      {
        ...
        defaultAssignee: 'clara@devtrace.io',
        defaultQaContact: 'david@devtrace.io',
      ...
      },
      {
        ...
        defaultAssignee: 'bob@devtrace.io',
        defaultQaContact: 'david@devtrace.io',
  ...
  {
    id: 'prod-cryptovault',
    name: 'CryptoVault Security Core',
    ...
    components: [
      {
        ...
        defaultAssignee: 'elena@devtrace.io',
        defaultQaContact: 'david@devtrace.io',
...
ASan panic: Heap-use-after-free on address \`0x7ffe83912040\` reading 8 bytes.`,
    ...
    reporterEmail: 'david@devtrace.io',
    assignee: 'Dr. Clara Schumann',
    assigneeEmail: 'clara@devtrace.io',
    qaContact: 'david@devtrace.io',
    ccList: ['alice@devtrace.io', 'bob@devtrace.io'],
    os: 'Linux',
    architecture: 'x86_64',
    ...
    flags: [
      {
        ...
        type: 'sec-audit',
        status: '+',
        requestee: 'bob@devtrace.io',
        setter: 'bob@devtrace.io',
      ...
      },
      {
        ...
        type: 'review',
        status: '?',
        requestee: 'alice@devtrace.io',
        setter: 'clara@devtrace.io',
    ...
    comments: [
      {
        ...
        reactions: [{ emoji: '👀', users: ['alice.vance', 'bob.miller'] }]
      },
      {
        id: 'c-2',
        author: 'Dr. Clara Schumann',
        authorEmail: 'clara@devtrace.io',
...
+   }
    ...
    return m_nativePointer;`,
        reactions: [{ emoji: '🚀', users: ['marcus.thorne', 'alice.vance'] }]
      }
    ],
    attachments: [
      {
  ...
  },
  {
    ...
    reporterEmail: 'alice@devtrace.io',
    assignee: 'Dr. Clara Schumann',
    assigneeEmail: 'clara@devtrace.io',
    qaContact: 'david@devtrace.io',
    ccList: ['clara@devtrace.io'],
    os: 'Linux',
    architecture: 'x86_64',
  ...
  },
  {
    ...
    reporterEmail: 'elena@devtrace.io',
    assignee: 'Alice Vance',
    assigneeEmail: 'alice@devtrace.io',
    qaContact: 'david@devtrace.io',
    ccList: ['elena@devtrace.io'],
    os: 'macOS',
    architecture: 'ARM64',
    ...
    comments: [
      {
        ...
        reactions: [{ emoji: '👍', users: ['alice.vance'] }]
      }
    ],
    attachments: [],
    auditLog: [],
...
\`[RAFT-CRIT] Node 3 candidate term 4821 failed quorum: received 2/5 votes (needed 3). Resetting randomized timeout.\``,
    ...
    qaContact: 'david@devtrace.io',
    ccList: ['clara@devtrace.io', 'alice@devtrace.io'],
    os: 'Linux',
    architecture: 'x86_64',
...
github.com/devtrace-org/aether/raft.(*RaftNode).Step(0xc0019a8200, {0x1, 0x3, 0x12d5, 0x0})
    ...
    comments: [
      {
        ...
        reactions: [{ emoji: '🔥', users: ['david.zhang', 'clara.schumann'] }]
      }
    ],
    attachments: [],
    auditLog: [
  ...
  },
  {
    ...
    severity: 'CRITICAL',
    priority: 'P1',
    reporter: 'Dr. Clara Schumann',
    reporterEmail: 'clara@devtrace.io',
    assignee: 'Dr. Clara Schumann',
    assigneeEmail: 'clara@devtrace.io',
    qaContact: 'david@devtrace.io',
...
Confidentiality breach on transaction shielding keys. CVSS score 7.5.`,
    product: 'CryptoVault Security Core',
    ...
    priority: 'P1',
    reporter: 'Bob Miller',
    reporterEmail: 'bob@devtrace.io',
    assignee: 'Bob Miller',
    assigneeEmail: 'bob@devtrace.io',
    qaContact: 'david@devtrace.io',
    ccList: ['alice@devtrace.io'],
    os: 'All',
    ...
    comments: [
      {
        ...
        reactions: [{ emoji: '🎉', users: ['alice.vance', 'david.zhang', 'clara.schumann'] }]
      }
    ],
    attachments: [],
    auditLog: [
  ...
  },
  {
    ...
    product: 'HyperFlow Developer UI',
    ...
    assigneeEmail: 'elena@devtrace.io',
    qaContact: 'david@devtrace.io',
    ccList: ['alice@devtrace.io'],
    os: 'Windows',
    architecture: 'x86_64',
