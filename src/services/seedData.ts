...
export const PRODUCTS: Product[] = [
  {
    id: 'prod-quantum',
    name: 'Case #104: The Phantom Scroll',
  ...
  {
    id: 'prod-aether',
    name: 'Case #209: Memory Leak Mystery',
  ...
  {
    id: 'prod-hyperflow',
    name: 'Case #404: Missing Auth Token',
...
ASan panic: Heap-use-after-free on address \`0x7ffe83912040\` reading 8 bytes.`,
    product: 'Case #104: The Phantom Scroll',
...
\`[RAFT-CRIT] Node 3 candidate term 4821 failed quorum: received 2/5 votes (needed 3). Resetting randomized timeout.\``,
    product: 'Case #209: Memory Leak Mystery',
...
Confidentiality breach on transaction shielding keys. CVSS score 7.5.`,
    product: 'Case #301: Rogue API Call',
  ...
  },
  {
    ...
    product: 'Case #404: Missing Auth Token',
